...
- [ ] **CURR-10**: All currency values configurable via TOML config

### Earnings

- [ ] **EARN-01**: Player earns configurable coins per mob killed
- [ ] **EARN-02**: Different mob types can have different reward values (configured in TOML)
...
- [ ] **EARN-05**: Player receives chat message when earning coins from any source
...
- [ ] **INFR-05**: Currency name and symbol configurable in TOML
